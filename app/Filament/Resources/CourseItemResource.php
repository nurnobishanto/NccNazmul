...
//                    ->relationship('module','title'),
                ...
                Forms\Components\FileUpload::make('pdf')->acceptedFileTypes(['application/ppt','application/pptx','application/pdf']),
//                Forms\Components\FileUpload::make('video'),
                Forms\Components\FileUpload::make('file')->acceptedFileTypes(['application/ppt','application/pptx','application/pdf']),
